...
/**
 * @file classes/sectionEditor/form/CreateTechnicalReviewerForm.inc.php
 *
 * Copyright (c) 2003-2011 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class CreateTechnicalReviewerForm
...
class CreateTechnicalReviewerForm extends Form {
	 ...
	 * Constructor.
	 */
	function CreateTechnicalReviewerForm($articleId) {
		parent::Form('sectionEditor/createTechnicalReviewerForm.tpl');
	...
	function execute() {
		...
		//add technical reviewer setting		
		$userDao->insertTechnicalReviewer($userId, Locale::getLocale());
