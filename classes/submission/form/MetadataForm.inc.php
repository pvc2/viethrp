...
class MetadataForm extends Form {
	...
	function MetadataForm($article, $journal) {
		...
		$this->addCheck(new FormValidatorLocale($this, 'scientificTitle', 'required', 'author.submit.form.vietScientificTitleRequired', 'vi_VN'));
		$this->addCheck(new FormValidatorLocale($this, 'publicTitle', 'required', 'author.submit.form.engPublicTitleRequired', 'en_US'));
		$this->addCheck(new FormValidatorLocale($this, 'publicTitle', 'required', 'author.submit.form.vietPublicTitleRequired', 'vi_VN'));
        ...
        $this->addCheck(new FormValidatorLocale($this, 'keywords', 'required', 'author.submit.form.vietKeywordsRequired', 'vi_VN'));
	...
	function getLocaleFieldNames() {
                 ...
                 *******************************************************************/
		return array('authorPhoneNumber', 'scientificTitle', 'publicTitle', 'studentInitiatedResearch', 'hsph', 'studentInstitution', 'supervisorFullName', 'supervisorEmail', 'supervisorPhone', 'supervisorAffiliation', 'academicDegree','background', 'objectives', 'studyMatters', 'expectedOutcomes', 'keywords', 'startDate', 'endDate', 'fundsRequired', 'selectedCurrency', 'primarySponsor', 'otherPrimarySponsor', 'secondarySponsors', 'otherSecondarySponsor', 'multiCountryResearch', 'multiCountry', 'proposalCountry', 'researchField', 'otherResearchField', 'withHumanSubjects','proposalType', 'otherProposalType', 'dataCollection', 'submittedAsPi', 'conflictOfInterest', 'reviewedByOtherErc', 'otherErcDecision', 'rtoOffice', 'industryGrant', 'nameOfIndustry', 'internationalGrant', 'internationalGrantName', 'otherInternationalGrantName', 'mohGrant', 'governmentGrant', 'governmentGrantName', 'universityGrant', 'selfFunding', 'otherGrant', 'specifyOtherGrant', 'identityRevealed', 'unableToConsent', 'under18', 'dependentRelationship', 'ethnicMinority', 'impairment', 'pregnant', 'newTreatment', 'bioSamples', 'radiation', 'distress', 'inducements', 'sensitiveInfo', 'deception', 'reproTechnology', 'genetics', 'stemCell', 'biosafety', 'riskLevel', 'listRisks', 'howRisksMinimized', 'riskApplyTo', 'benefitsFromTheProject', 'multiInstitutions');
	...
	function display() {
		...
		//Get list of divisions of Vietnam
        $provinceDAO =& DAORegistry::getDAO('ProvincesOfVietnamDAO');
        $proposalCountries =& $provinceDAO->getProvincesOfVietnam();
...
array(
		...
		if ($this->_data['section']->getAbstractsNotRequired() == 0) {
			...
			$this->addCheck(new FormValidatorLocale($this, 'background', 'required', 'author.submit.form.vietBackgroundRequired', 'vi_VN'));
			$this->addCheck(new FormValidatorLocale($this, 'objectives', 'required', 'author.submit.form.engObjectivesRequired', 'en_US'));
			$this->addCheck(new FormValidatorLocale($this, 'objectives', 'required', 'author.submit.form.vietObjectivesRequired', 'vi_VN'));
			$this->addCheck(new FormValidatorLocale($this, 'studyMatters', 'required', 'author.submit.form.engStudyMattersRequired', 'en_US'));
			$this->addCheck(new FormValidatorLocale($this, 'studyMatters', 'required', 'author.submit.form.vietStudyMattersRequired', 'vi_VN'));
			...
			$this->addCheck(new FormValidatorLocale($this, 'expectedOutcomes', 'required', 'author.submit.form.vietExpectedOutcomesRequired', 'vi_VN'));
		}
	}
