...
{assign var="pageTitle" value="sectionEditor.review.createTechnicalReviewer"}
...
<form method="post" name="reviewerForm" action="{url op="createTechnicalReviewer" path=$articleId|to_array:"create"}">
