...
<script type="text/javascript" src="http://localhost/viethrp-release1/viethrp/lib/pkp/js/lib/jquery/jquery.min.js"></script>
<script type="text/javascript" src="http://localhost/viethrp-release1/viethrp/lib/pkp/js/lib/jquery/plugins/jqueryUi.min.js"></script>
...
{literal}
<script type="text/javascript" src="http://localhost/viethrp/lib/pkp/js/lib/jquery/jquery-ui-timepicker-addon.js"></script>
