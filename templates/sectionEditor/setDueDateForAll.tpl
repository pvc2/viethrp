...
<script type="text/javascript" src="http://localhost:8888/vnhrp/lib/pkp/js/lib/jquery/jquery.min.js"></script>
<script type="text/javascript" src="http://localhost:8888/vnhrp/lib/pkp/js/lib/jquery/plugins/jqueryUi.min.js"></script>
...
{literal}
<script type="text/javascript" src="http://localhost:8888/vnhrp/lib/pkp/js/lib/jquery/jquery-ui-timepicker-addon.js"></script>
