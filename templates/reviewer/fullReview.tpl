...
<table class="listing" width="100%">
	<tr><td colspan="6"><strong>{translate key="editor.article.decision.assigned"}</strong></td></tr>
	<tr><td colspan="6" class="headseparator">&nbsp;</td></tr>
	<tr class="heading" valign="bottom">
		<td width="20%">{translate key="common.id"}</td> <!-- Replaced id with ID, SPF, 21 Dec 2011 -->
		<td width="20%">{translate key="submissions.submit"}</td>
