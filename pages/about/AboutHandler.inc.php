...
class AboutHandler extends Handler {
	...
	function contact() {
		...
		*/
		...
		$secretary =& $userSettingsDao->getUsersBySetting("secretaryStatus", "HSPH Secretary");
		$secretary =& $secretary->toArray();
		
		$ercChair =& $userSettingsDao->getUsersBySetting("hsphMemberStatus", "HSPH Chair");
		$ercChair =& $ercChair->toArray();
		
		$ercViceChair =& $userSettingsDao->getUsersBySetting("hsphMemberStatus", "HSPH Vice-Chair");
		$ercViceChair =& $ercViceChair->toArray();		
		
		$ercMembers =& $userSettingsDao->getUsersBySetting("hsphMemberStatus", "HSPH Member");
	...
	function editorialTeam() {
		...
		$secretary =& $userSettingsDao->getUsersBySetting("secretaryStatus", "CREC Secretary");
		$secretary =& $secretary->toArray();

		$ercChair =& $userSettingsDao->getUsersBySetting("crecMemberStatus", "CREC Chair");
		$ercChair =& $ercChair->toArray();
		
		$ercViceChair =& $userSettingsDao->getUsersBySetting("crecMemberStatus", "CREC Vice-Chair");
		$ercViceChair =& $ercViceChair->toArray();	
		
		$ercMembers =& $userSettingsDao->getUsersBySetting("crecMemberStatus", "CREC Member");
		$ercMembers =& $ercMembers->toArray();
